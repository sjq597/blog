...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      var logging = !proxy_gateway ? _utils.http.post('http://118.24.5.177:3000', { code: code, client_id: client_id, client_secret: client_secret }, '') : _utils.http.post('/login/oauth/access_token', 'code=' + code + '&client_id=' + client_id, proxy_gateway);
